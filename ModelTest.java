...
import lab4.model.Algorithm;
import lab4.model.NegativeNodeException;
...
Algorithm.Algo algo = Algorithm.Algo.GOOD;
System.out.println("Algorithm enum inside the class is set a value: "+ algo);
assertEquals(Algorithm.Algo.valueOf("GOOD"), algo);
Algorithm.Algo algo1 = Algorithm.Algo.BAD;
System.out.println("Algorithm enum inside the class is set a value: "+ algo1);
assertEquals(Algorithm.Algo.valueOf("BAD"), algo1);
Algorithm.Algo algo2 = Algorithm.Algo.AVERAGE;
